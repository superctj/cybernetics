...
def test_convert_ddpg_action_to_dbms_config():
    dbms_param_spec = "/home/phdonn/cybernetics/cybernetics/knobs/postgres_12.17_pgtune_knobs.json"
    n_initial_configs = 10
    random_seed = 12345
    results_save_path = "/home/phdonn/cybernetics/exps/benchbase_tpcc/postgres/rl_ddpg"
