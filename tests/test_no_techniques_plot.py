...
print(
    "Running with no transformation:"
)
...
print(
    f"Runtime for no transformation: {end_time - start_time} seconds"
)
...
plt.savefig("/home/samika/cybernetics/exps/benchbase_tpcc/postgres/bo_gp/throughput_vs_iteration_no_techniques_10.png")